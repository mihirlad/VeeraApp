...
namespace VeeraApp
{
    public partial class PurchaseReturnDCBill : System.Web.UI.Page
    {
        ...
        public void clear()
        {
            ...
            TxtSupplierNameDebit.Text = string.Empty;
        ...
        {
            TxtSupplierNameDebit.Enabled = true;
        ...
        {
            TxtSupplierNameDebit.Enabled = false;
            TxtInvoiceNumber.Enabled = false;
        ...
        protected void TxtSupplierNameDebit_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("select ACODE from ACCOUNTS where ANAME = '" + TxtSupplierNameDebit.Text + "' and COMP_CODE = " + Session["COMP_CODE"].ToString(), con);
                int x = Convert.ToInt32(cmd.ExecuteScalar());
                if (x == 0)
                {
                    TxtSupplierNameDebit.BackColor = Color.Red;

                }
                else
                {
                    HfACODEDebit.Value = cmd.ExecuteScalar().ToString();
                    TxtSupplierNameDebit.BackColor = Color.White; con.Close();
        ...
        public void FillAccountGSTNumber()
        {
            try
            {
                string ACODE = HfACODEDebit.Value;
                DataTable Dt = new DataTable();
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (Convert.ToDecimal(TxtNetAmt.Text) > 0)
                    {
                        ...
                        {
                            lblmsg.Text = "PURCHASE RETURN INVOICE MASTER SAVE SUCCESSFULLY.";
                        ...
                        {
                            lblmsg.Text = "PURCHASE RETURN INVOICE MASTER ALREADY EXIST.";
                            lblmsg.ForeColor = Color.Red;
                        }
                        else
                        {
                            lblmsg.Text = "ERROR : PURCHASE RETURN INVOICE MASTER NOT SAVED";
                            lblmsg.ForeColor = Color.Red;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Convert.ToDecimal(TxtNetAmt.Text) > 0)
                {
                    ...
                    if (str.Contains("successfully"))
                    {
                        lblmsg.Text = "PURCHASE RETURN TAX INVOICE MASTER UPDATE SUCCESSFULLY.";
                        lblmsg.ForeColor = Color.Green;
                        clear(); 
                        FillREC_ISS_MasterGrid(Session["COMP_CODE"].ToString());
                        UserRights();
                    ...
                    {
                        lblmsg.Text = "PURCHASE RETURN TAX INVOICE MASTER ALREADY EXIST.";
                        lblmsg.ForeColor = Color.Red;
                    }
                    else
                    {
                        lblmsg.Text = "ERROR : PURCHASE RETURN TAX INVOICE MASTER NOT SAVED";
                        lblmsg.ForeColor = Color.Red;
        ...
        public void FillCreditACNameOnUpdate(string Id)
        {
            try
            {
        ...
        public void FillPartySupplierNameOnUpdate(string Id)
        {
            try
            {
                ...
                if (HfACODEDebit.Value.ToString() != "0" && HfACODEDebit.Value != null && HfACODEDebit.Value.ToString() != string.Empty) 
                {
                    ...
                    TxtSupplierNameDebit.Text = DtView.Rows[0]["ANAME"].ToString();
                ...
                if (e.CommandName == "Deletea")
                {
                    ...
                    if (ctrl != null)
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            FillPartySupplierNameOnUpdate(dt.Rows[0]["DRACODE"].ToString());                     
                            HfAODECredit.Value = dt.Rows[0]["CRACODE"].ToString();
                            FillCreditACNameOnUpdate(dt.Rows[0]["CRACODE"].ToString());
        ...
        protected void GvStockRecDetails_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            try
            {
                ...
                if (e.Row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if (HfTranType.Value == "C" && HfTrnType.Value == "R")
                    {
        ...
        public void FillDeliveryChallanGridrPopup()
        {
            try
            {
                ...
                Dt = DC_MASLogicLayer.GetAllDC_MasWiseComapnyAndACodeForTaxInvoiceBill(Session["COMP_CODE"].ToString(), Session["BRANCH_CODE"].ToString(), HfACODEDebit.Value,"D".ToString(), "C".ToString());
