...
{
    public partial class WarrantyProductData : System.Web.UI.Page
    {
           ...
           Session["DELETE"] != null)
            {
                ...
                if (!IsPostBack == true)
                {
                    ...
                    if (!string.IsNullOrWhiteSpace(Request.QueryString["AMC_TYPE"]))
                    {
        ...
        public void FillAMCMasterGrid(string CompCode)
        {
            ...
            Dt = AMC_MASLogicLayer.GetAllWARRANTY_MASDetials(Convert.ToInt32(Session["USERCODE"].ToString()), Convert.ToInt32(Session["COMP_CODE"].ToString()));
            DataView Dv = new DataView(Dt);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    lblmsg.Text = "WARRANTY MASTER UPDATE SUCCESSFULLY.";
                ...
                {
                    lblmsg.Text = "WARRANTY MASTER ALREADY EXIST.";
                    lblmsg.ForeColor = Color.Red;
                }
                else
                {
                    lblmsg.Text = "ERROR : WARRANTY MASTER NOT UPDATED";
                    lblmsg.ForeColor = Color.Red;
        ...
        protected void BtncallUpd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (str.Contains("successfully"))
                    {
                        lblmsg.Text = "WARRANTY MASTER SAVE SUCCESSFULLY.";
                        lblmsg.ForeColor = Color.Green;
                        clear();
                        FillAMCMasterGrid(Session["COMP_CODE"].ToString());
                        UserRights();
                    ...
                    {
                        lblmsg.Text = "ERROR : WARRANTY MASTER NOT SAVED";
                        lblmsg.ForeColor = Color.Red;
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    lblmsg.Text = "Error:Warranty Master Deleted";
                    lblmsg.ForeColor = Color.Red;
                }
                clear();
                UserRights();
