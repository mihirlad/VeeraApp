...
{
    public partial class BranchTransactionReport : System.Web.UI.Page
    {
          ...
          Session["DELETE"] != null)

            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    if (HfTranType.Value.ToString() == "BI")
                    {
                        H1.Visible = true;
                        H2.Visible = false;
                    }

                    if (HfTranType.Value.ToString() == "BR")
                    {
                        H1.Visible = false;
                        H2.Visible = true;
                    }
        ...
        protected void BtnDateWiseChallan_Click(object sender, EventArgs e)
        {
            ...
            Session["TRAN_TYPE"] = HfTranType.Value.Trim();
            ...
            if(HfTranType.Value.ToString()=="BI")
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "openpage", "window.open('../ViewerInventory/ViewBranchTransactionStockIssuePrintReport.aspx', '_blank');", true);
            }
            else
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "openpage", "window.open('../ViewerInventory/ViewBranchTransactionStockReceivedPrintReport.aspx', '_blank');", true);
            }
        ...
        protected void BtnBranchWiseChallan_Click(object sender, EventArgs e)
        {
            SessionClear();
        ...
        protected void BtnBranchWiseDetailsChallan_Click(object sender, EventArgs e)
        {
            SessionClear();
            ...
            Session["REPORT_TYPE"] = "BRANCH_WS_DET";
