...
namespace VeeraApp.Admin
{
    public partial class DeliveryChallanReport : System.Web.UI.Page
    {
           ...
           Session["DELETE"] != null)

            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    if (HfTranType.Value.ToString()=="D" && HfTrnType.Value.ToString() == "P")
                    {
                        HdForPurchase.Visible = true;
                        HdForSales.Visible = false;
                    }

                    if (HfTranType.Value.ToString() == "D" && HfTrnType.Value.ToString() == "S")
                    {
        ...
        protected void BtnDateWiseChallan_Click(object sender, EventArgs e)
        {
            SessionClear();
            ...
            Session["VIEW_REPORT"] = DdlViewReport.SelectedValue.Trim();

            Session["REPORT_TYPE"] = "DT_WS";

            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "openpage", "window.open('../ViewerInventory/ViewDeliveryChallanPrint.aspx', '_blank');", true);
        }



        protected void BtnDateWiseDetailsChallan_Click(object sender, EventArgs e)
        {
            SessionClear();
            ...
            Session["REPORT_TYPE"] = "DT_WS_DETAILS";

            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "openpage", "window.open('../ViewerInventory/ViewDeliveryChallanWithDetailsPrint.aspx', '_blank');", true);

        }

        protected void BtnPartyWiseChallan_Click(object sender, EventArgs e)
        {
            SessionClear();
            ...
            Session["REPORT_TYPE"] = "PT_WS";

            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "openpage", "window.open('../ViewerInventory/ViewDeliveryChallanPrint.aspx', '_blank');", true);
        }

        protected void BtnPartyWiseDetailsChallan_Click(object sender, EventArgs e)
        {
            SessionClear();
            ...
            Session["REPORT_TYPE"] = "PT_WS_DETAILS";
