...
namespace VeeraApp.Admin
{
    public partial class QuotationReport : System.Web.UI.Page
    {
        ...
        protected void DdlViewReport_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                Session["QUO_TYPE"] = DdlViewReport.SelectedValue.Trim();
            }
            catch (Exception)
            {
        ...
        protected void BtnDateWiseQuotation_Click(object sender, EventArgs e)
        {
            SessionClear();
            ...
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "openpage", "window.open('../ViewerInventory/ViewQuotationPrint.aspx', '_blank');", true);
        }

        protected void BtnDateWiseDetailsQuotation_Click(object sender, EventArgs e)
        {
            SessionClear();
            ...
            Session["REPORT_TYPE"] = "DT_DET";

            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "openpage", "window.open('../ViewerInventory/ViewQuotationWithDetailsPrint.aspx', '_blank');", true);
        }

        protected void BtnPartyWiseQuotation_Click(object sender, EventArgs e)
        {
            SessionClear();
        ...
        protected void BtnPartyWiseDetailsQuotation_Click(object sender, EventArgs e)
        {
            SessionClear();
