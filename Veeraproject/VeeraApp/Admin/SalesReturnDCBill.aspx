<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Main.Master" AutoEventWireup="true" CodeBehind="SalesReturnDCBill.aspx.cs" Inherits="VeeraApp.Admin.SalesReturnDCBill" %>
        ...
        <div class="forms">
            <div class="form-grids widget-shadow" data-example-id="basic-forms">
                <div class="form-title">
                    <h4 id="PageTitlePurchaseBill" runat="server">SALES RETURN BILL</h4>
             </div>
        </div>
    </div>
 </div>
