<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Main.Master" AutoEventWireup="true" CodeBehind="WarrantyProductData.aspx.cs" Inherits="VeeraApp.Admin.WarrantyProductData" %>
        ...
        <div class="forms">
            <div class="form-grids widget-shadow" data-example-id="basic-forms">
                <div class="form-title">
                    <h4>WARRANTY DATA TRANSACTION</h4>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="form-group" style="border-bottom: none;">
                            ...
                            <asp:UpdatePanel ID="updpnl" runat="server">
                                <ContentTemplate>
                                    ...
                                    <div class="h5" style="color: brown">Warranty Master</div>
                                            ...
                                            <table class="col-md-12">
                                                ...
                                                <tr>
                                                    <td align="right" style="padding-bottom: 10px;">
                                                        <asp:Label CssClass="label" Text="Warranty No." runat="server"></asp:Label>
                                                    </td>
                                                    ...
                                                    <td align="right" style="padding-bottom: 10px;">
                                                        <asp:Label CssClass="label" Text="Warranty Date" runat="server"></asp:Label>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td align="right" style="padding-bottom: 10px;">
                                                        <asp:Label CssClass="label" Text="Warranty Start From Date" runat="server"></asp:Label>
                                                    </td>
                                                    ...
                                                    <td align="right" style="padding-bottom: 10px;">
                                                        <asp:Label CssClass="label" Text="Warranty To Date" runat="server"></asp:Label>
                                                    </td>
                                                ...
                                                <tr>
                                                  ...
                                                  <%--  <td align="right" style="padding-bottom: 10px;">
                                                        <asp:Label CssClass="label" Text="Warranty Billing Terms" runat="server"></asp:Label>
                                                    </td>
                                                    <td colspan="3" style="padding-left: 10px;">
                                    ...
                                    <asp:UpdatePanel ID="UpdPnlPartyDetails" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <div class="table-responsive" style="height: 272px; overflow-y: scroll">
                                                <div class="h5" style="color: brown; text-align: left">Warranty Detail</div>
                ...
                <div class="table-responsive">
                    <asp:GridView ID="GvAMCMaster" CssClass="table table-vcenter table-condensed table-bordered"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="WARRANTY FROM DATE">
                                <ItemTemplate>
                                    <asp:Label CssClass="label" ID="lblAMCFromDate" runat="server" Text='<%#Bind("AMC_FRDT") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="WARRANTY TO DATE">
                                <ItemTemplate>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">DELETE WARRANTY MASTER DETAIL</h4>
                </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">UPDATE WARRANTY MASTER DETAIL</h4>
                    </div>
                    <div class="modal-body">
