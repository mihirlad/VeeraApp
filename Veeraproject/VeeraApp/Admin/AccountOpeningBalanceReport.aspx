<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Main.Master" AutoEventWireup="true" CodeBehind="AccountOpeningBalanceReport.aspx.cs" Inherits="VeeraApp.Admin.AccountOpeningBalanceReport" %>
        ...
        <div class="forms">
            <div class="form-grids widget-shadow" data-example-id="basic-forms">
                <div class="form-title">
                    <h4 id="hdForOpBal" runat="server">OPENING BALANCE STATEMENTS</h4>
                    <h4 id="hdForTradingAcc" runat="server">TRADING ACCOUNTS STATEMENTS</h4>
                    <h4 id="hdForProftLossAcc" runat="server">PROFIT & LOSS ACCOUNTS STATEMENTS</h4>
                    <h4 id="hdForTrdaingProfitLoss" runat="server">TRADING + PROFIT & LOSS A/C</h4>
                    <h4 id="hdForBalanceShret" runat="server">BALANCE SHEET STATEMENTS</h4>
                </div>
            </div>
        </div>
    </div>
