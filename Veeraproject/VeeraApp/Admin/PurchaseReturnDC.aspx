<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Main.Master" AutoEventWireup="true" CodeBehind="PurchaseReturnDC.aspx.cs" Inherits="VeeraApp.Admin.PurchaseReturnDC" %>
        ...
        <div class="forms">
            <div class="form-grids widget-shadow" data-example-id="basic-forms">
                <div class="form-title">
                    <h4>DELIVERY CHALLAN-PURCHASE RETURN </h4>
                </div>
            </div>
        </div>
    </div>
              ...
              <div class="tabl-respeonsive" style="height: 500px; overflow-y: scroll">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="GvDCSalesMaster" CssClass="table table-vcenter table-condensed table-bordered"
                        runat="server" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging="GvDCSalesMaster_PageIndexChanging" OnRowCommand="GvDCSalesMaster_RowCommand" OnRowDataBound="GvDCSalesMaster_RowDataBound"
                        PageSize="10">
                        <PagerStyle CssClass="pagination pagination-sm remove-margin" />
                        <Columns>
                                        ...
                                        <td colspan="100%">
                                            <div id='div<%#Eval("TRAN_NO") %>' class="table-responsive" style="display: none; background-color: lightgray">
                                                ...
                                                <asp:GridView ID="GvNestedDCDetails" Style="background: #e6ffee;" CssClass="table table-vcenter table-condensed table-bordered"
                                                    runat="server" AutoGenerateColumns="false" AllowPaging="false" OnPageIndexChanging="GvNestedDCDetails_PageIndexChanging"
                                                    PageSize="10">
                                                    <PagerStyle CssClass="pagination pagination-sm remove-margin" />
                                                    <Columns>
                                    ...
                                    <asp:GridView ID="GvViewBarcode" CssClass="table table-vcenter table-condensed table-bordered"
                                        ...
                                        <Columns> 
                                            ...
                                            <asp:TemplateField HeaderText="Barcode">
                                                <ItemTemplate>
                                                    <asp:TextBox CssClass="form-control" ID="TxtBarcode" OnTextChanged="TxtBarcode_TextChanged" AutoPostBack="true" runat="server" Text='<%#Bind("BARRCODE") %>'></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
