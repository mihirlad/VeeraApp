<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Main.Master" AutoEventWireup="true" CodeBehind="EmployeeLoanMaster.aspx.cs" Inherits="VeeraApp.Admin.EmployeeLoanMaster" %>
        ...
        <div class="forms">
            <div class="form-grids widget-shadow" data-example-id="basic-forms">
                <div class="form-title">
                    ...
                    <h4 id="HdForAdvanceMaster" runat="server">EMPLOYEE AVANCE MASTER</h4>
                </div>
            </div>
        </div>
    </div>
                                ...
                                <ContentTemplate>
                                    ...
                                    <div class="auto-style1">
                                        <div class="col-md-12">
                                            ...
                                            <div class="col-md-1">
                                                <asp:Label CssClass="label" Text="Loan Date" runat="server"></asp:Label>
                                            ...
                                            <div class="col-md-1">
                                                <asp:Label CssClass="label" Text="Loan Amount" runat="server"></asp:Label>
