...
namespace VeeraApp
{
    public partial class PurchaseOrderMas : System.Web.UI.Page
    {
        ...
        public void FillOrder_MasterGrid(string CompCode)
        {
            ...
            Dt = ORDER_MASLogicLayer.GetAllORDER_MASDetails(Convert.ToInt32(Session["USERCODE"].ToString()), Convert.ToInt32(Session["COMP_CODE"].ToString()), "P".ToString());
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string str = ORDER_MASLogicLayer.UpdateORDER_MASDetail(insert, validation.RSC(XDoc1.OuterXml),null);

                if (str.Contains("successfully"))
                {
                    lblmsg.Text = "PURCHASE ORDER MASTER UPDATE  SUCCESSFULLY.";
                ...
                {
                    lblmsg.Text = "PURCHASE ORDER MASTER ALREADY EXIST.";
                    lblmsg.ForeColor = Color.Red;
                }
                else
                {
                    lblmsg.Text = "ERROR :PURCHASE ORDER MASTER NOT SAVED";
                    lblmsg.ForeColor = Color.Red;
        ...
        protected void BtncallUpd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    string str = ORDER_MASLogicLayer.InsertORDER_MASDetail(insert, validation.RSC(XDoc1.OuterXml),null, Session["COMP_CODE"].ToString(), Session["BRANCH_CODE"].ToString(),HfTransType.Value.ToString(), Convert.ToDateTime(Session["FIN_YEAR"].ToString()).ToString("yyyy-MM-dd"));
                    ...
                    if (str.Contains("successfully"))
                    {
                        ...
                        lblmsg.Text = "PURCHASE ORDER MASTER SAVE SUCCESSFULLY.";
                        lblmsg.ForeColor = Color.Green;
                        clear();
                        FillOrder_MasterGrid(Session["COMP_CODE"].ToString());
                        UserRights();
