...
{
    public partial class PurchaseReturnDC : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    lblmsg.Text = "PURCHASE RETURN DELIVERY CHALLAN MASTER UPDATE SUCCESSFULLY.";
                ...
                {
                    lblmsg.Text = "PURCHASE RETURN DELIVERY CHALLAN MASTER ALREADY EXIST.";
                    lblmsg.ForeColor = Color.Red;
                }
                else
                {
                    lblmsg.Text = "ERROR : PURCHASE RETURN DELIVERY CHALLAN MASTER NOT SAVED";
                    lblmsg.ForeColor = Color.Red;
        ...
        protected void BtncallUpd_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (str.Contains("successfully"))
                    {
                        lblmsg.Text = "PURCHASE RETURN DEIVERY CHALLAN MASTER SAVE SUCCESSFULLY.";
                        lblmsg.ForeColor = Color.Green;
                        clear();
                        FillDC_MasterGrid(Session["COMP_CODE"].ToString());
                        UserRights();
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (HfTranNo.Value != string.Empty && HfTranDate.Value != string.Empty)
                {
                    ...
                    {
                        lblmsg.Text = "Error:Purchase Return Delivery Challan Not Deleted";
                        lblmsg.ForeColor = Color.Red;
                    }
                    clear();
                    FillDC_MasterGrid(Session["COMP_CODE"].ToString());
        ...
        public void FillCustomerGridForPopup()
        {
            try
            {
                ...
                Dt = ACCOUNTS_MASLogicLayer.GetAllGroupCodeWise_PartyDetailsForGrid(Session["COMP_CODE"].ToString(), Session["BRANCH_CODE"].ToString(), "7");
        ...
        #region Calculation On Stock Deatils Grid
        ...
        #region Calculation On Extra Stock Details grid
        ...
        #region Barcode Process Into Stock Details Grid
        ...
        protected void TxtBarcode_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dupbarcode == "")
                {
                    ...
                    TextBox TxtBarcodeinner = (TextBox)rowinner.Cells[2].FindControl("TxtBarcode");
