...
{
    public partial class AssemblyDeAssmeblyReport : System.Web.UI.Page
    {
          ...
          Session["DELETE"] != null)

            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    {
                        HdForAssemble.Visible = true;
                        HdForDeAssemble.Visible = false;
                    }

                    if (HfTranType.Value.ToString() == "D")
                    {
                        HdForAssemble.Visible = false;
                        HdForDeAssemble.Visible = true;
                    }
                    else
                    {
        ...
        protected void BtnDateWise_Click(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "openpage", "window.open('../ViewerInventory/ViewAssembleDetailsPrint.aspx', '_blank');", true);
        }
        ...
        protected void BtnItemWise_Click(object sender, EventArgs e)
        {
            ...
            Session["REPORT_TYPE"] = "IT_WS_DETAILS";
