<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Main.Master" AutoEventWireup="true" CodeBehind="WorkListMaster.aspx.cs" Inherits="VeeraApp.Admin.WorkListMaster" %>
                ...
                <asp:UpdatePanel ID="UpdPnl" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="auto-style1">
                            <div class="col-md-9">
                                <asp:HiddenField ID="HfWorkCode" runat="server" />
                                <asp:HiddenField ID="HfCompCode" runat="server" />

                                <asp:Label CssClass="label" Text="Work Description" runat="server"></asp:Label>
                                <asp:TextBox ID="TxtWorkDescrption" CssClass="form-control" runat="server"></asp:TextBox>
                                <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator1" runat="server"
                                    ControlToValidate="TxtWorkDescrption" ForeColor="Red">*</asp:RequiredFieldValidator>
                            </div>
                        ...
                        <div class="panel panel-widget top-grids">
                            <div class="chute chute-center text-center">
                                ...
                                <div class="table-responsive" style="height: 272px; overflow-y: scroll">
                                    <div class="h5" style="color: brown">WORK LIST DEATILS</div>
                                    <asp:GridView ID="GvStockPriceDet" CssClass="table table-vcenter table-condensed table-bordered"
                                        runat="server" AutoGenerateColumns="false" AllowPaging="false" ShowFooter="true" OnRowCommand="GvStockPriceDet_RowCommand"
                                        PageSize="10">
                                        <PagerStyle CssClass="pagination pagination-sm remove-margin" />
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:Button ID="btnView" runat="server" CausesValidation="false" CommandName="Selecta" CommandArgument='<%#Bind("WORK_CODE") %>' ToolTip="View" Text="SELECT" CssClass="btn-primary btn-sm" BorderStyle="None"></asp:Button>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="WORK DESCRIPTION" ControlStyle-Width="350px">
                                                <ItemTemplate>
                                                    <asp:Label CssClass="label" ID="lblWorkDescription" runat="server" Text='<%#Bind("WORK_NAME") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField HeaderText="JOB CATEGORY" ControlStyle-Width="350px">
                                                <ItemTemplate>
