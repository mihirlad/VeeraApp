<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Main.Master" AutoEventWireup="true" CodeBehind="ServiceInvoiceBill.aspx.cs" Inherits="VeeraApp.Admin.ServiceInvoiceBill" %>
        ...
        <div class="forms">
            <div class="form-grids widget-shadow" data-example-id="basic-forms">
                <div class="form-title">
                    <h4 runat="server">SERVICE BILL</h4>
                                ...
                                <ContentTemplate>
                                  ...
                                  <%--  <asp:HiddenField ID="HfInvoiceBillType" runat="server" />--%>
                                   ...
                                   <%-- <div class="h5" style="color: brown">Service Issue To Branch </div>--%>
                                      ...
                                      <asp:HiddenField ID="HfJobcard_TranNo" runat="server" />
                                      <asp:HiddenField ID="HfJobcard_TranDate" runat="server" />
...
<%--                                                        <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator10" runat="server"
                                                ...
                                                <tr>
                                                      <tr>
                                                    <td align="right" style="padding-bottom: 10px;">
                                                        <asp:Label CssClass="label" Text="Service By" ForeColor="Blue" runat="server"></asp:Label>
                                                    </td>
                                                    <td colspan="3" style="padding-left: 10px;">
                                                        <asp:HiddenField ID="HfServicePerson" runat="server" />
                                                        <asp:TextBox ID="TxtServicePerson" OnTextChanged="TxtServicePerson_TextChanged" AutoPostBack="true" CssClass="form-control" ForeColor="Blue" runat="server"></asp:TextBox>
                                                        <ajax:AutoCompleteExtender ID="AutoCompleteExtender2" runat="server" TargetControlID="TxtServicePerson"
                                                            MinimumPrefixLength="1" EnableCaching="true" CompletionSetCount="1" CompletionInterval="1000"
                                                            ServiceMethod="GetServicePersonName">
                                                        </ajax:AutoCompleteExtender>

                                                     <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldServicePerson" runat="server"
                                                            ControlToValidate="TxtServicePerson" ForeColor="Red">*</asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                        ...
                                        <div class="col-md-12">
                                            <table class="col-md-12">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 10px;">
                                                        <asp:TextBox ID="TxtJobCardNo" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </td>                                                
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 10px;" colspan="2">
                                                     ...
                                                     <td align="right" style="padding-bottom: 10px;">
                                                       ...
                                                       <td style="padding-left: 10px;" colspan="2">
                                                        <asp:TextBox ID="TxtJobCardDate" AutoPostBack="true" CssClass="form-control" runat="server"></asp:TextBox>
                                                        ...
                                                        <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator1" runat="server"
                                                            ControlToValidate="TxtInvoiceDate" ForeColor="Red">*</asp:RequiredFieldValidator>--%>
                                                        <ajax:CalendarExtender runat="server" ID="CalendarExtender1" Format="dd-MM-yyyy" TargetControlID="TxtInvoiceDate"></ajax:CalendarExtender>
                                                    </td>
                                        ...
                                        <ContentTemplate>
                                             ...
                                             <%--  <div class="table-responsive" style="height: 272px; overflow-y: scroll">
                                                ...
                                                <asp:GridView ID="GvStockRecDetails" CssClass="table table-vcenter table-condensed table-bordered"
                                                    runat="server" Visible="false" AutoGenerateColumns="false" AllowPaging="true" OnPageIndexChanging="GvStockRecDetails_PageIndexChanging" OnRowDataBound="GvStockRecDetails_RowDataBound"
                                            ...
                                            <div class="table-responsive" style="height: 272px; overflow-y: scroll">
                                                ...
                                                <asp:GridView ID="GvChagresTranDetails" CssClass="table table-vcenter table-condensed table-bordered"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="CHARGES DESCRIPTION" ControlStyle-Width="200px">
                                                            <ItemTemplate>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="ACTION">
                                <ItemTemplate>
                                    ...
                                    <asp:Button ID="btnEdit" runat="server" Enabled='<%# Eval("REC_UPD").ToString().Equals("Y") && Eval("REF_TRAN_DATE").ToString().Equals("01-01-1900 00:00:00") %>' CausesValidation="false" CommandName="Edita" CommandArgument='<%#Bind("TRAN_NO") %>' ToolTip="Edit" Text="EDIT" CssClass="btn-primary  btn-sm" BorderStyle="None"></asp:Button>

                                    <asp:Button ID="btnDelete" runat="server" Enabled='<%# Eval("REC_DEL").ToString().Equals("Y")  && Eval("REF_TRAN_DATE").ToString().Equals("01-01-1900 00:00:00") %>' CausesValidation="false" CommandName="Deletea" CommandArgument='<%#Bind("TRAN_NO") %>' ToolTip="Delete" Text="DELETE" CssClass="btn-primary btn-sm" BorderStyle="None"></asp:Button>
                        ...
                        <div class="panel panel-widget top-grids">
                            ...
                            <asp:UpdatePanel ID="UpModalAddChallan" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:GridView Visible="false" ID="GvAddDeliveryChallan" CssClass="table table-vcenter table-condensed table-bordered"
                        ...
                        <div class="panel panel-widget top-grids">
                            <asp:UpdatePanel ID="UpdateBarcode" runat="server">
                                <ContentTemplate>
                                    ...
                                    <asp:GridView Visible="false" ID="GvViewBarcode" CssClass="table table-vcenter table-condensed table-bordered" OnPageIndexChanging="GvViewBarcode_PageIndexChanging"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Barcode">
                                                <ItemTemplate>
                                                    <asp:TextBox CssClass="form-control" ID="TxtBarcode" AutoPostBack="true" runat="server" Text='<%#Bind("BARCODE") %>'></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
