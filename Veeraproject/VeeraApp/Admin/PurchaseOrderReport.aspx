<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Main.Master" AutoEventWireup="true" CodeBehind="PurchaseOrderReport.aspx.cs" Inherits="VeeraApp.Admin.PurchaseOrderReport" %>
        ...
        <div class="forms">
            <div class="form-grids widget-shadow" data-example-id="basic-forms">
                <div class="form-title">
                    <h4 id="HdForPurchase" runat="server">PURCHASE ORDER REPORTS</h4>
                    <h4 id="HdForSales" runat="server">SALES ORDER REPORTS</h4>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <div style="float: center; height: auto; width: 40%;">
                                        <div class="col-md-12">
                                            <table class="col-md-12">
                                                ...
                                                <tr>
                                                    <td align="right" style="padding-bottom: 10px;">
                                                        <asp:Label CssClass="label" Text="From Order No." runat="server"></asp:Label>
                                                    </td>
                                                    <td style="padding-left: 10px;">
                                                        <asp:TextBox ID="TxtFromOrderNo" AutoPostBack="true" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </td>

                                                    <td align="right" style="padding-bottom: 10px;">
                                                        <asp:Label CssClass="label" Text="To Order No. " runat="server"></asp:Label>
                                                    </td>
                                                    <td style="padding-left: 10px;">
                                                        <asp:TextBox ID="TxtToOrderNo" AutoPostBack="true" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 10px;" colspan="5">
                                                        ...
                                                        <asp:TextBox ID="TxtCategoryName" ForeColor="Blue" CssClass="form-control" OnTextChanged="TxtCategoryName_TextChanged" AutoPostBack="true" runat="server"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 10px;" colspan="5">
                                                        ...
                                                        <asp:TextBox ID="TxtProductCode" ForeColor="Blue" CssClass="form-control" runat="server" OnTextChanged="TxtProductCode_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 10px;" colspan="5">
                                                        ...
                                                        <asp:TextBox ID="TxtProductName" ForeColor="Blue" CssClass="form-control" runat="server" OnTextChanged="TxtProductName_TextChanged" AutoPostBack="true"></asp:TextBox>
                       ...
                       <table class="col-md-4">
                           ...
                           <tr>
                              <td style="padding-bottom: 10px;" colspan="3">
                                <asp:Button ID="BtnDateWise_OrderDetailsReport" runat="server" Text="DateWise + Details Order" CssClass="btn btn-lg btn-primary btn-block" OnClick="BtnDateWise_OrderDetailsReport_Click" CausesValidation="true" />   <%--OnClientClick="aspnetForm.target ='_blank';"--%>
                              </td>
                           </tr>

                            <tr>
                              <td style="padding-bottom: 10px;" colspan="3">
                                <asp:Button ID="BtnPartyWise_OrderDetailsReport" runat="server" Text="PartyWise + Details Order" CssClass="btn btn-lg btn-primary btn-block"  OnClick="BtnPartyWise_OrderDetailsReport_Click" CausesValidation="true" />   <%--OnClientClick="aspnetForm.target ='_blank';"--%>
                              </td>
                           </tr>

                          <tr>
                              <td style="padding-bottom: 10px;" colspan="3">
                                <asp:Button ID="BtnPartyWise_OutstandingDetailsReport" runat="server" Text="PartyWise OutStanding [Detail]" CssClass="btn btn-lg btn-primary btn-block" OnClick="BtnPartyWise_OutstandingDetailsReport_Click" CausesValidation="true" />   <%--OnClientClick="aspnetForm.target ='_blank';"--%>
                              </td>
                           </tr>
