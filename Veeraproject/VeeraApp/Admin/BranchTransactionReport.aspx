<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Main.Master" AutoEventWireup="true" CodeBehind="BranchTransactionReport.aspx.cs" Inherits="VeeraApp.Admin.BranchTransactionReport" %>
        ...
        <div class="forms">
            <div class="form-grids widget-shadow" data-example-id="basic-forms">
                <div class="form-title">
                    <h4 id="H1" runat="server">ISSUE TO BRANCH REPORTS</h4>
                    <h4 id="H2" runat="server">RECEIVED FROM BRANCH REPORTS</h4>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td style="padding-left: 10px;" colspan="5">
                                                        <asp:DropDownList ID="DdlViewReport"  AutoPostBack="true" runat="server" CssClass="form-control">
                                                            <asp:ListItem Value="ALL" Selected="True">All Challan</asp:ListItem>
                                                            <asp:ListItem Value="CNF">Received Challan</asp:ListItem>
                                                            <asp:ListItem Value="NCNF">Non-Received Challan</asp:ListItem>
              ...
              <div style="float: center; height: auto; width: 40%;">
                   <div class="col-md-12">
                       <table class="col-md-4">
                           ...
                           <tr>
                              <td style="padding-bottom: 10px;" colspan="3">
                                <asp:Button ID="BtnBranchWiseChallan" runat="server" Text="BranchWise Challan" CssClass="btn btn-lg btn-primary btn-block" OnClick="BtnBranchWiseChallan_Click" CausesValidation="true" />   <%--OnClientClick="aspnetForm.target ='_blank';"--%>
                              </td>
                           </tr>

                          <tr>
                              <td style="padding-bottom: 10px;" colspan="3">
                                <asp:Button ID="BtnBranchWiseDetailsChallan" runat="server" Text="BranchWise + Detail Challan" CssClass="btn btn-lg btn-primary btn-block" OnClick="BtnBranchWiseDetailsChallan_Click" CausesValidation="true" />    <%--OnClientClick="aspnetForm.target ='_blank';"--%>
                              </td>
                           </tr>
                       ...
                       <tr>
                        ...
                        <td style="padding-bottom: 10px;">
                            <asp:Button ID="BtnExit" runat="server" Text="Exit" CssClass="btn btn-lg btn-primary btn-block" CausesValidation="false" />
                        </td>
                          </tr>
