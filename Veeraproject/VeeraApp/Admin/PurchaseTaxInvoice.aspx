<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Main.Master" AutoEventWireup="true" CodeBehind="PurchaseTaxInvoice.aspx.cs" Inherits="VeeraApp.Admin.PurchaseTaxInvoice" %>
        ...
        <div class="forms">
            <div class="form-grids widget-shadow" data-example-id="basic-forms">
                <div class="form-title">
                    <h4 id="PageTitlePurchaseBill" runat="server">PURCHASE BILL</h4>
                    <h4 id="PageTitleGeneralBill" runat="server">GENERAL BILL</h4>
             </div>
        </div>
    </div>
 </div>
                                            ...
                                            <table class="col-md-12">
                                                  ...
                                                  <tr id="trExpenseAccount" runat="server">
                                                    <td align="right" style="padding-bottom: 10px;">
                                                        <asp:Label ID="Label1" CssClass="label" Text="Expense A/C" ForeColor="Blue" runat="server"></asp:Label>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 10px;" colspan="3">
                                                        ...
                                                        <asp:TextBox ID="TxtSupplierNameCredit" OnTextChanged="TxtSupplierNameCredit_TextChanged" AutoPostBack="true" CssClass="form-control" ForeColor="Blue" runat="server"></asp:TextBox>
                                                        <ajax:AutoCompleteExtender ID="AutoCompleteExtenderProdCode" runat="server" TargetControlID="TxtSupplierNameCredit"
                                                            MinimumPrefixLength="1" EnableCaching="true" CompletionSetCount="1" CompletionInterval="1000"
                                                            ServiceMethod="GetAccountName">
                                                        </ajax:AutoCompleteExtender>

                                                        <asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator6" runat="server"
                                                            ControlToValidate="TxtSupplierNameCredit" ForeColor="Red">*</asp:RequiredFieldValidator>
                                                    </td>
                                                </tr>
                                        ...
                                        <div class="col-md-12">
                                            <table class="col-md-12">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 10px;">
                                                        <asp:TextBox ID="TxtReceiveDate"  AutoPostBack="true" CssClass="form-control" runat="server"></asp:TextBox>
                                                        ...
                                                        <ajax:CalendarExtender runat="server" ID="CalendarExtenderTxtReceiveDate" Format="dd-MM-yyyy" TargetControlID="TxtReceiveDate"></ajax:CalendarExtender>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 10px;">
                                                        ...
                                                        <%--<asp:RequiredFieldValidator Display="Dynamic" ID="RequiredFieldValidator1" runat="server"
                                                            ControlToValidate="TxtInvoiceDate" ForeColor="Red">*</asp:RequiredFieldValidator>--%>
                                                        <ajax:CalendarExtender runat="server" ID="CalendarExtender2" Format="dd-MM-yyyy" TargetControlID="TxtInvoiceDate"></ajax:CalendarExtender>
                                                    </td>
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td></td>
                                                    <td>
                                                         <asp:Button runat="server" ID="btnViewGeneralBillChallan" OnClick="btnViewGeneralBillChallan_Click" Text="View-Challan"   OnClientClick="aspnetForm.target ='_blank';"/>
                                                    </td>
                                                    <td>
                                        ...
                                        <div class="col-md-12">
                                            <table class="col-md-12">
                                                ...
                                                <tr>
                                                 ...
                                                 <tr id="trPurchaseAgainstForm" runat="server">
                                                    <td align="right" style="padding-bottom: 10px;">
                                                        <asp:Label CssClass="label" Text="Purchase Against Form" runat="server"></asp:Label>
                                                    </td>
                                                    <td style="padding-left: 10px;">
                                                        <asp:TextBox ID="TxtPurchaseAgainstFrom" CssClass="form-control" runat="server"></asp:TextBox>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 10px;">
                                                        <asp:DropDownList ID="DdlFigureFlag" OnSelectedIndexChanged="DdlFigureFlag_SelectedIndexChanged" AutoPostBack="true"  runat="server" CssClass="form-control">
                                                            <asp:ListItem Value="0">SELECT TYPE</asp:ListItem>
                    ...
                    <asp:GridView ID="GvTaxInvoiceMaster" CssClass="table table-vcenter table-condensed table-bordered"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="CUSTOMER A/C">
                                <ItemTemplate>
                                    <asp:Label CssClass="label" ID="lblCustPartyName" runat="server" Text='<%#Bind("AccountNameCredit") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
