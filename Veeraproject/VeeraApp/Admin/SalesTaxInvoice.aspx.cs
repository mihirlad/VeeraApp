...
namespace VeeraApp
{
    public partial class SalesTaxInvoice : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
             ...
             Session["DELETE"] != null)
            {
                ...
                if (HfTranType.Value == "S" && HfTrnType.Value == "P")
                {
                    ...
                    PageTitlePerfomaInvoice.Visible = true;
                    PageTitleSalesInvoice.Visible = false;
                    PageTiltleCashInvoice.Visible = false;
                    PageTitleCashMemoInvoice.Visible = false;
                    PageTitleRetailInvoice.Visible = false;
                    lblCustomerACForChallan.Visible = true;
                    trConsigneeNameForChallan.Visible = true;
                    lblCashACForBarcode.Visible = false;
                    trPartyName.Visible = false;
                    trpartyaddress.Visible = false;
                    BtnAddChallan.Visible = false;
                    DivBarcodeViewButtons.Visible = false;
                    //  GetAccountCode();
                }
                ...
                if (HfTranType.Value == "S" && HfTrnType.Value == "T")
                {
                    ...
                    PageTitlePerfomaInvoice.Visible = false;
                    PageTitleSalesInvoice.Visible = true;
                    PageTiltleCashInvoice.Visible = false;
                    PageTitleCashMemoInvoice.Visible = false;
                    PageTitleRetailInvoice.Visible = false;
                    lblCustomerACForChallan.Visible = true;
                ...
                if (HfTranType.Value == "S" && HfTrnType.Value == "R")
                {
                    ...
                    PageTiltleCashInvoice.Visible = false;
                    PageTitleCashMemoInvoice.Visible = false;
                    PageTitleRetailInvoice.Visible = true;
                    lblCustomerACForChallan.Visible = true;
                    trConsigneeNameForChallan.Visible = true;
                    lblCashACForBarcode.Visible = false;
                    trPartyName.Visible = false;
                ...
                else if (HfTranType.Value == "S" && HfTrnType.Value == "M")
                {
                    ...
                    PageTitleSalesInvoice.Visible = false;
                    PageTiltleCashInvoice.Visible = false;
                    PageTitleCashMemoInvoice.Visible = true;
                    PageTitleRetailInvoice.Visible = false;
                    lblCustomerACForChallan.Visible = false;
                    trConsigneeNameForChallan.Visible = false;
                    lblCashACForBarcode.Visible = true;
                    trPartyName.Visible = true;
                    trpartyaddress.Visible = true;
                    BtnAddChallan.Visible = false;
                    DivBarcodeViewButtons.Visible = true;
                ...
                else if (HfTranType.Value == "S" && HfTrnType.Value == "C")
                {
                    PageTitlePerfomaInvoice.Visible = false;
                    PageTitleSalesInvoice.Visible = false;
                    PageTiltleCashInvoice.Visible = true;
                    PageTitleCashMemoInvoice.Visible = false;
                    PageTitleRetailInvoice.Visible = false;
                    lblCustomerACForChallan.Visible = false;
                    trConsigneeNameForChallan.Visible = false;
        ...
        public void clear()
        {
            ...
            HfACODECredit.Value = string.Empty;
            HfAODEDebit.Value = string.Empty;
            ...
            TxtSoldAgainstFrom.Text = string.Empty;
        ...
        public void ControllerEnable()
        {
            ...
            TxtSoldAgainstFrom.Enabled = true;
        ...
        public void ControllerDisable()
        {
            ...
            DdlTaxCalType.Enabled = false;
            TxtSoldAgainstFrom.Enabled = false;
        ...
        protected void TxtConsigneeName_TextChanged(object sender, EventArgs e)
        {
            try
            {
                System.Data.SqlClient.SqlConnection con = new System.Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
                con.Open();
                System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("select ACODE from ACCOUNTS where ANAME = '" + TxtConsigneeName.Text + "' and COMP_CODE = " + Session["COMP_CODE"].ToString(), con);
                int x = Convert.ToInt32(cmd.ExecuteScalar());
                if (x == 0)
                {
                    TxtConsigneeName.BackColor = Color.Red;

                }
                else
                {
                    HfConsigneePartyCode.Value = cmd.ExecuteScalar().ToString();
                    TxtConsigneeName.BackColor = Color.White; con.Close();
                }
            }
            catch (Exception)
            {
                    ...
                    if (DtView.Rows.Count > 0)
                    {
                        ...
                        if (HfChargesCode.Value != string.Empty && DdlPartyType.SelectedIndex != 0)
                        {
                            ...
                            if (DsStock.Rows.Count > 0)
                            {
                                ...
                                // if (HfTranType.Value != "S" && (HfTrnType.Value != "C" || HfTrnType.Value!="M"))
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Convert.ToDecimal(TxtNetAmt.Text) > 0)
                {
                    ...
                    insert.PARTY_NAME = TxtPartyNameForCashMemo.Text.Trim().ToUpper();
                    insert.PARTY_ADD = "";
                    insert.BCODE = null;
                    insert.BAMT = null;
                    insert.INV_NO = null;
                    ...
                    {
                        insert.BUYERACODE = HfConsigneePartyCode.Value.Trim();
                    }
                    ...
                    {
                        insert.FORM_SRNO = TxtFormSrNo.Text.Trim();
                    }
            ...
            try
            {
                ...
                else
                {
                    if (Convert.ToDecimal(TxtNetAmt.Text) > 0)
                    {
                        ...
                        insert.REMOVAL_TIME_HH = null;
                        insert.REMOVAL_TIME_MM = null;
                        insert.CFORM_FLAG = TxtSoldAgainstFrom.Text.Trim().ToUpper();
                        insert.CFORM_NO = "";
                        insert.EX_DUTY_PER = null;
                        insert.EX_DUTY_AMT = null;
                        insert.EX_CESS_PER = null;
        ...
        public void FillConsigneeNameOnUpdate(string Id)
        {
            try
            {
                string Comp_Code = HfCompCode.Value.Trim();
                ...
                if (HfConsigneePartyCode.Value.ToString() != "0" && HfConsigneePartyCode.Value != null && HfConsigneePartyCode.Value.ToString() != string.Empty)
                {
                    DataView Dv = new DataView(Dt);
                    Dv.RowFilter = "ACODE=" + Id;
                    DataTable DtView = Dv.ToTable();

                    TxtConsigneeName.Text = DtView.Rows[0]["ANAME"].ToString();
                    HfConsigneePartyCode.Value = DtView.Rows[0]["ACODE"].ToString();
                ...
                if (e.CommandName == "Deletea")
                {
                    ...
                    if (ctrl != null)
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            HfConsigneePartyCode.Value = dt.Rows[0]["BUYERACODE"].ToString();
                            FillConsigneeNameOnUpdate(dt.Rows[0]["BUYERACODE"].ToString());
                            TxtPartyNameForCashMemo.Text = dt.Rows[0]["PARTY_NAME"].ToString();
                            ...
                            TxtSoldAgainstFrom.Text = dt.Rows[0]["CFORM_FLAG"].ToString();
                                ...
                                if (FilterBarcode.Rows.Count > 0)
                                {
                                    ...
                                    if (table.Rows.Count > 0)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            dr["SCODE"] = FilterBarcode.Rows[0]["SCODE"].ToString();
                                            dr["PRODUCT_DESC"] = string.Empty;
                                            dr["HSN_NO"] = FilterBarcode.Rows[0]["HSN_NO"].ToString();//
                                            dr["QTY"] = 1;
                                            ...
                                            if (HfTranType.Value.ToString() == "S" && HfTrnType.Value.ToString() == "C")
                                            {
                                            ...
                                            else if (HfTranType.Value.ToString() == "S" && HfTrnType.Value.ToString() == "M")
                                            {
                                                dr["GST_RATE"] = string.Empty;
                                                dr["GST_AMT"] = string.Empty;
                                                dr["CGST_RATE"] = string.Empty;
                                    ...
                                    else
                                    {
                                        ...
                                        dr["SCODE"] = FilterBarcode.Rows[0]["SCODE"].ToString();
                                        dr["PRODUCT_DESC"] = string.Empty;
                                        dr["HSN_NO"] = FilterBarcode.Rows[0]["HSN_NO"].ToString(); //string.Empty; 
                                        dr["QTY"] = 1;
                                        dr["RATE"] = FilterBarcode.Rows[0]["RATE"].ToString();
                                        dr["AMT"] = HfAmountString;
                                        dr["DIS_PER"] = string.Empty;
