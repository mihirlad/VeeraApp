...
{
    public partial class AllBillRegisterReport : System.Web.UI.Page
    {
          ...
          Session["DELETE"] != null)

            {
                ...
                if (!Page.IsPostBack)
                {
                    ...
                    else if (HfTranType.Value.ToString() == "G" && HfTrnType.Value.ToString() == "R")
                    {
                        H1.Visible = false;
                        H2.Visible = true;
                        H3.Visible = false;
                    ...
                    else if (HfTranType.Value.ToString() == "S" && HfTrnType.Value.ToString() == "T")
                    {
                        H1.Visible = false;
                        H2.Visible = false;
                        H3.Visible = true;
                    ...
                    else if (HfTranType.Value.ToString() == "J" && HfTrnType.Value.ToString() == "R")
                    {
                        H1.Visible = false;
                        H2.Visible = false;
                        H3.Visible = false;
        ...
        protected void BtnItemWisePartyWise_Click(object sender, EventArgs e)
        {
            SessionClear();

            if (HfSCODE.Value.ToString() != string.Empty && HfSCODE.Value.ToString() != null && HfSCODE.Value.ToString() != "0")
            {
                ...
                if (HfTrnType.Value != string.Empty)
                {
                    Session["TRN_TYPE"] = HfTrnType.Value.Trim().ToString();
                }
                else
                {
                ...
                Session["REPORT_TYPE"] = "IT_WS_PT";


                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "openpage", "window.open('../ViewerInventory/ViewBillRegisterPrint.aspx', '_blank');", true);
            }
            else
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Product Name/Code must be enter..!!');", true);
            }


        }

        protected void BtnPartyWiseItemWise_Click(object sender, EventArgs e)
        {
            SessionClear();

            if (HfACODE.Value.ToString() != string.Empty && HfACODE.Value.ToString() != null && HfACODE.Value.ToString() != "0")
            {
                //MIHIR LAD
                string csv_branch = GetBranchList();
            ...
            {
                ScriptManager.RegisterStartupScript(this, GetType(), "showalert", "alert('Party Name must be enter..!!');", true);
            }

        }

        protected void BtnPartyWiseBillWise_Click(object sender, EventArgs e)
        {
            SessionClear();
            ...
            if (HfACODE.Value.ToString() != string.Empty && HfACODE.Value.ToString() != null && HfACODE.Value.ToString() != "0")
            {
                ...
                Session["REPORT_TYPE"] = "PT_WS_BILL";
