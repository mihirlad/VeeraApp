<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Main.Master" AutoEventWireup="true" CodeBehind="AMC_RateMaster.aspx.cs" Inherits="VeeraApp.Admin.AMC_RateMaster" %>
                ...
                <div class="form-body">
                    <div class="form-horizontal form-bordered">
                        <div class="form-group" style="border-bottom: none;">
                            ...
                            <div class="h5" style="color: brown">AMC RATE MASTER</div>
                                ...
                                <ContentTemplate>
                                    ...
                                    <asp:TextBox ID="TxtSrNo" CssClass="form-control" runat="server"></asp:TextBox>
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <asp:TextBox ID="TxtFromDate" Style="text-align: center;" CssClass="form-control" runat="server" OnTextChanged="TxtFromDate_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <asp:TextBox ID="TxtToDate" Style="text-align: center;" CssClass="form-control" runat="server" OnTextChanged="TxtToDate_TextChanged" AutoPostBack="true"></asp:TextBox>
                                        ...
                                        <div class="col-md-1">
                                            <asp:Label CssClass="label" Text="Created By" runat="server"></asp:Label>
                                            <asp:TextBox ID="TxtCreatedBy" CssClass="form-control" runat="server"></asp:TextBox>
                                        </div>
                                        <div class="col-md-1">
                                            <asp:Label CssClass="label" Text="Created Date" runat="server"></asp:Label>
                                            <asp:TextBox ID="TxtCreatedDate" CssClass="form-control" runat="server"></asp:TextBox>
                                        </div>
                                        <div class="col-md-1">
                                            <asp:Label CssClass="label" Text="Updated By" runat="server"></asp:Label>
                                            <asp:TextBox ID="TxtUpdatedBy" CssClass="form-control" runat="server"></asp:TextBox>
                                        </div>
                                        <div class="col-md-1">
                                            <asp:Label CssClass="label" Text="Updated Date" runat="server"></asp:Label>
                                            <asp:TextBox ID="TxtUpdatedDate" CssClass="form-control" runat="server"></asp:TextBox>
                                        </div>
                                    ...
                                    <div class="panel panel-widget top-grids">
                                        <div class="chute chute-center text-center">
                                            ...
                                            <div class="table-responsive" style="height: 272px; overflow-y: scroll">
                                                ...
                                                <asp:GridView ID="GvStockPriceDet" CssClass="table table-vcenter table-condensed table-bordered" OnRowDataBound="GvStockPriceDet_RowDataBound"
                                                    runat="server" AutoGenerateColumns="false" AllowPaging="false" ShowFooter="true"
                                                    PageSize="10">
                                                    <PagerStyle CssClass="pagination pagination-sm remove-margin" />
                                                    <Columns>

                                                        <asp:TemplateField HeaderText="BRAND NAME" ControlStyle-Width="250px">
                                                            <ItemTemplate>
                                                         ...
                                                         <asp:TemplateField HeaderText="MODEL NAME" ControlStyle-Width="250px">
                                                            <ItemTemplate>
                                                          ...
                                                          <asp:TemplateField HeaderText="MODEL DESCRIPTION" ControlStyle-Width="350px">
                                                            <ItemTemplate>
                                                             <asp:TextBox CssClass="form-control" ID="TxtModelDescription" runat="server"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                          <asp:TemplateField HeaderText="AMC RATE">
                                                            <ItemTemplate>
                                                                <asp:TextBox CssClass="form-control" Style="text-align: right;" onkeypress="return isNumber(event);" ID="TxtAMCRate" runat="server" Text='<%#Bind("AMC_RATE") %>'></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="MAX DIS.%">
                                                            <ItemTemplate>
                                                                <asp:TextBox CssClass="form-control" Style="text-align: right;" onkeypress="return isNumber(event);" OnTextChanged="TxtMaxDiscount_TextChanged" AutoPostBack="true" ID="TxtMaxDiscount" runat="server" Text='<%#Bind("MAX_DIS_PER") %>'></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                           <asp:TemplateField HeaderText="MAX DIS.RATE">
                                                            <ItemTemplate>
                                                                <asp:TextBox CssClass="form-control" Style="text-align: right;" onkeypress="return isNumber(event);" ID="TxtMaxDiscountRate" runat="server" Text='<%#Bind("MAX_DIS_RATE") %>'></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                         <asp:TemplateField HeaderText="MIN DIS.%">
                                                            <ItemTemplate>
                                                                <asp:TextBox CssClass="form-control" Style="text-align: right;" onkeypress="return isNumber(event);" OnTextChanged="TxtMinDiscount_TextChanged" AutoPostBack="true" ID="TxtMinDiscount" runat="server" Text='<%#Bind("MIN_DIS_PER") %>'></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                           <asp:TemplateField HeaderText="MIN DIS.RATE">
                                                            <ItemTemplate>
                                                                <asp:TextBox CssClass="form-control" Style="text-align: right;" onkeypress="return isNumber(event);" ID="TxtMinDiscountRate" runat="server" Text='<%#Bind("MIN_DIS_RATE") %>'></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                           <asp:TemplateField HeaderText="PER SERVICE RATE">
                                                            <ItemTemplate>
                                                                <asp:TextBox CssClass="form-control" Style="text-align: right;" onkeypress="return isNumber(event);" ID="TxtPerServiceRate" runat="server" Text='<%#Bind("PER_SERVICE_RATE") %>'></asp:TextBox>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
        ...
        <div class="panel panel-widget top-grids">
            <div class="chute chute-center text-center">
                ...
                <div class="table-responsive">
                    <asp:GridView ID="GvAMCRateMaster" CssClass="table table-vcenter table-condensed table-bordered"
                        runat="server" AutoGenerateColumns="false" AllowPaging="false" OnPageIndexChanging="GvAMCRateMaster_PageIndexChanging" OnRowCommand="GvAMCRateMaster_RowCommand"
                        PageSize="10">
                        <PagerStyle CssClass="pagination pagination-sm remove-margin" />
                        <Columns>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">DELETE AMC RATE MASTER DETAIL</h4>
                </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">UPDATE AMC RATE MASTER DETAIL</h4>
                    </div>
                    <div class="modal-body">
