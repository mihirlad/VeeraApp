<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Main.Master" AutoEventWireup="true" CodeBehind="DeliveryChallanReport.aspx.cs" Inherits="VeeraApp.Admin.DeliveryChallanReport" %>
        ...
        <div class="forms">
            <div class="form-grids widget-shadow" data-example-id="basic-forms">
                <div class="form-title">
                    <h4 id="HdForPurchase" runat="server">PURCHASE CHALLAN REPORTS</h4>
                    <h4 id="HdForSales" runat="server">SALES CHALLAN REPORTS</h4>
                </div>
            </div>
        </div>
    </div>
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td style="padding-left: 10px;" colspan="5">
                                                        <asp:DropDownList ID="DdlViewReport" OnSelectedIndexChanged="DdlViewReport_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control">
                                                            <asp:ListItem Value="AL" Selected="True">All Challan</asp:ListItem>
                                                            <asp:ListItem Value="CC">Confirm Challan</asp:ListItem>
                                                            <asp:ListItem Value="NCNF">Non-Confirm Challan</asp:ListItem>
                                                            <asp:ListItem Value="GBC">Generate Bill Challan</asp:ListItem>
                                                            <asp:ListItem Value="NGB">>Non-Generate Bill Challan</asp:ListItem>
                                                            <asp:ListItem Value="F">FOC Challan</asp:ListItem>
                                                            <asp:ListItem Value="C">Cancel Challan</asp:ListItem>
                                                            <asp:ListItem Value="T">Returnable Challan</asp:ListItem>
                       ...
                       <table class="col-md-4">
                           ...
                           <tr>
                              <td style="padding-bottom: 10px;" colspan="3">
                                <asp:Button ID="BtnDateWiseChallan" runat="server" Text="DateWise Challan" CssClass="btn btn-lg btn-primary btn-block" OnClick="BtnDateWiseChallan_Click" CausesValidation="true" />   <%--OnClientClick="aspnetForm.target ='_blank';"--%>
                              </td>
                           </tr>

                            <tr>
                              <td style="padding-bottom: 10px;" colspan="3">
                                <asp:Button ID="BtnDateWiseDetailsChallan" runat="server" Text="DateWise + Detail Challan" CssClass="btn btn-lg btn-primary btn-block"  OnClick="BtnDateWiseDetailsChallan_Click" CausesValidation="true" />   <%--OnClientClick="aspnetForm.target ='_blank';"--%>
                              </td>
                           </tr>

                          <tr>
                              <td style="padding-bottom: 10px;" colspan="3">
                                <asp:Button ID="BtnPartyWiseChallan" runat="server" Text="PartyWise Challan" CssClass="btn btn-lg btn-primary btn-block" OnClick="BtnPartyWiseChallan_Click" CausesValidation="true" />    <%--OnClientClick="aspnetForm.target ='_blank';"--%>
                              </td>
                           </tr>

                          <tr>
                              <td style="padding-bottom: 10px;" colspan="3">
                                <asp:Button ID="BtnPartyWiseDetailsChallan" runat="server" Text="PartyWise + Details Challan" CssClass="btn btn-lg btn-primary btn-block" OnClick="BtnPartyWiseDetailsChallan_Click" CausesValidation="true" />    <%--OnClientClick="aspnetForm.target ='_blank';"--%>
                              </td>
                           </tr>
