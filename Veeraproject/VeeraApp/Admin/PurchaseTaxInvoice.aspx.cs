...
{
    public partial class PurchaseTaxInvoice : System.Web.UI.Page
    {
           ...
           Session["DELETE"] != null)
            {
                ...
                if (!IsPostBack == true)
                {
                    if (!string.IsNullOrWhiteSpace(Request.QueryString["Tran_Type"]) && !string.IsNullOrWhiteSpace(Request.QueryString["Trn_Type"]))
                    {
                        ...
                        CalendarExtenderTxtReceiveDate.StartDate = Convert.ToDateTime(Session["FIN_YEAR"].ToString());
                        CalendarExtenderTxtReceiveDate.EndDate = Convert.ToDateTime(Session["FIN_YEAR_END"].ToString());
                ...
                if (HfTranType.Value == "P" && HfTrnType.Value == "R")
                {

                    PageTitlePurchaseBill.Visible = true;
                    PageTitleGeneralBill.Visible = false;
                    trExpenseAccount.Visible = false;
                    trPurchaseAgainstForm.Visible = true;
                    BtnAddChallan.Visible = true;
                    btnViewGeneralBillChallan.Visible = false;

                }

                if (HfTranType.Value == "G" && HfTrnType.Value == "R")
                {

                    PageTitlePurchaseBill.Visible = false;
                    PageTitleGeneralBill.Visible = true;
                    trExpenseAccount.Visible = true;
                    trPurchaseAgainstForm.Visible = false;
                    BtnAddChallan.Visible = false;
                    btnViewGeneralBillChallan.Visible = true;
        ...
        public void clear()
        {
            ...
            TxtPurchaseAgainstFrom.Text = string.Empty;
        ...
        public void ControllerEnable()
        {
            ...
            TxtPurchaseAgainstFrom.Enabled = true;
        ...
        public void ControllerDisable()
        {
            ...
            TxtPurchaseAgainstFrom.Enabled = false;
        ...
        protected void TxtExpenseAccount_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                System.Data.SqlClient.SqlConnection con = new System.Data.SqlClient.SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString"].ToString());
                con.Open();
                System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand("select ACODE from ACCOUNTS where ANAME = '" + TxtExpenseAccount.Text + "' and COMP_CODE = " + Session["COMP_CODE"].ToString(), con);
                int x = Convert.ToInt32(cmd.ExecuteScalar());
                if (x == 0)
                {
                    TxtSupplierNameCredit.BackColor = Color.Red;
                ...
                {
                    HfACODEDebit.Value = cmd.ExecuteScalar().ToString();
                    TxtExpenseAccount.BackColor = Color.White; con.Close();
                }
            }
            catch (Exception)
            {
        ...
        public void GetAccountCode()
        {
            ...
            HfAODECredit.Value = DtACODE.Rows[0]["CREDIT"].ToString();
            HfACODEDebit.Value = DtACODE.Rows[0]["DEBIT"].ToString();

            if (HfAODECredit.Value != string.Empty)
            {
                DataTable DtAName = new DataTable();
                DtAName = ACCOUNTS_MASLogicLayer.GetAllIDWiseACCOUNTDetials(HfAODECredit.Value);
                TxtSupplierNameCredit.Text = DtAName.Rows[0]["ANAME"].ToString();
                TxtSupplierNameCredit.Enabled = false;
        ...
        protected void BtnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                TxtReceiveDate.Text = System.DateTime.Now.ToString("dd-MM-yyyy");
                TxtDueDate.Text = System.DateTime.Now.ToString("dd-MM-yyyy");
                ...
                if(HfTranType.Value.ToString()=="P" && HfTrnType.Value.ToString() == "R")
                {
                    GetAccountCode();
                }
                ...
                string INV_Number = REC_ISS_MLogicLayer.GetInvoiceNumber(Session["COMP_CODE"].ToString(), Session["BRANCH_CODE"].ToString(), Convert.ToDateTime(Session["FIN_YEAR"]).ToString("yyyy-MM-dd"), HfTranType.Value.ToString(), HfTrnType.Value.ToString(), Convert.ToDateTime(TxtReceiveDate.Text.Trim()).ToString("yyyy-MM-dd"));
                if (INV_Number.Length <= 8)
                {
                    TxtInvoiceNumber.Text = INV_Number;
                    TxtInvoiceNumber.Enabled = false;
        ...
        protected void BtncallUpd_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    insert.BCODE = null;
                    insert.BAMT = null;
                    insert.INV_NO = TxtInvoiceNo.Text.Trim().ToUpper();
                    ...
                    {
                        insert.REC_DT = Convert.ToDateTime(TxtReceiveDate.Text.Trim().ToUpper()).ToString("MM-dd-yyyy");
                    }
                    ...
                    insert.CHA_NO = TxtDCNo.Text.Trim();
                    ...
                    if (TxtPurchaseAgainstFrom.Text == string.Empty)
                    {
                        insert.FORM_SRNO = null;
                    }
                    else
                    {
                        insert.FORM_SRNO = TxtPurchaseAgainstFrom.Text.Trim();
                    }
                    ...
                    insert.INV_REASON = "";
                    insert.EWAY_BILLNO = TxtEWayBill.Text.Trim().ToUpper();
                    ...
                    if (str.Contains("successfully"))
                        {
                            ...
                            //    for (int m = 0; m < DtDCMASter.Rows.Count; m++)
                            //    {
                            //        DC_MASLogicLayer.UpdateDC_MAS_StatusWhenGenerateBill(Convert.ToDateTime(DtDCMASter.Rows[m]["DCTransDate"].ToString()), DtDCMASter.Rows[m]["DCTransNo"].ToString());
                            //    }
                            //}
        ...
        public void FillDebitAccountOnUpdate(string Id)
        {
            try
            {
                string Comp_Code = HfCompCode.Value.Trim();
                ...
                if (e.CommandName == "Deletea")
                {
                    ...
                    if (ctrl != null)
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            FillPartyNameOnUpdate(dt.Rows[0]["CRACODE"].ToString());
                            ...
                            TxtReceiveDate.Text = Convert.ToDateTime(dt.Rows[0]["REC_DT"].ToString()).ToString("dd-MM-yyyy");
                            ...
                            TxtEWayBill.Text = dt.Rows[0]["EWAY_BILLNO"].ToString();
                            ...
                            TxtPurchaseAgainstFrom.Text = dt.Rows[0]["FORM_SRNO"].ToString();
                ...
                if (e.CommandName == "Edita")
                {
                    ...
                    if (ctrl != null)
                    {
                        ...
                        if (dt.Rows.Count > 0)
                        {
                            ...
                            HfACODEDebit.Value = dt.Rows[0]["DRACODE"].ToString();
                            FillPartyNameOnUpdate(dt.Rows[0]["CRACODE"].ToString());
                            FillDebitAccountOnUpdate(dt.Rows[0]["DRACODE"].ToString());
                            TxtPONo.Text = dt.Rows[0]["PO_NO"].ToString();
                            TxtPODate.Text = dt.Rows[0]["PO_DT"].ToString();
                            TxtTransportName.Text = dt.Rows[0]["TRANSPORT"].ToString();
                            TxtVehclieNo.Text = dt.Rows[0]["VEHICLE_NO"].ToString();
                    ...
                    if (DtView.Rows.Count > 0)
                    {
                        ...
                        if (HfChargesCode.Value != string.Empty && DdlPartyType.SelectedIndex != 0)
                        {
                            ...
                            if (DsStock.Rows.Count > 0)
                            {
                                ...
                                if ((HfTranType.Value == "G" && HfTrnType.Value == "R" && DdlRegisterType.SelectedValue == "R") || (HfTranType.Value == "P" && HfTrnType.Value == "R"))
                                {
        ...
        protected void TxtQty_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (txt.Text.Trim() != string.Empty && TxtRateString.Text.Trim() != string.Empty)
                {
                    ...
                    {
                        T_AMTString.Text = TxtChargesAmount.Text;
                    }
        ...
        public void FillDeliveryChallanGridrPopup()
        {
            try
            {
                ...
                Dt = DC_MASLogicLayer.GetAllDC_MasWiseComapnyAndACodeForTaxInvoiceBill(Session["COMP_CODE"].ToString(), Session["BRANCH_CODE"].ToString(), HfAODECredit.Value,"D".ToString(),"P".ToString());
        ...
        protected void btnViewInvoive_Click(object sender, EventArgs e)
        {
            if(HfTranType.Value=="G" && HfTrnType.Value=="R")
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "openpage", "window.open('../reportviewPages/GeneralBillInvoicePrint.aspx', '_blank');", true);
            }
            else
            {
        ...
        protected void btnViewGeneralBillChallan_Click(object sender, EventArgs e)
        {
            if(HfTranType.Value=="G" && HfTrnType.Value=="R")
            {
                ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "openpage", "window.open('../reportviewPages/GenreralBillChallanPrint.aspx', '_blank');", true);
            }
        }

        #region Calculation On Round Figure 

        public void ChargesDetailCalRoundFigure()
        {
            try
            {
                if (DdlFigureFlag.SelectedValue.ToString() == "R")
                {
                    foreach (GridViewRow row in GvChagresTranDetails.Rows)
                    {
                        HiddenField HfChargesCode = ((HiddenField)row.FindControl("HfChargesCode"));
                        TextBox TxtChargesName = ((TextBox)row.FindControl("TxtChargesName"));
                        TextBox TxtQty = ((TextBox)row.FindControl("TxtQty"));
                        TextBox TxtRate = ((TextBox)row.FindControl("TxtRate"));
                        TextBox TxtChargesAmount = ((TextBox)row.FindControl("TxtChargesAmount"));
                        TextBox TxtCGSTAmount = ((TextBox)row.FindControl("TxtCGSTAmount"));
                        TextBox TxtSGSTAmount = ((TextBox)row.FindControl("TxtSGSTAmount"));
                        TextBox TxtIGSTAmount = ((TextBox)row.FindControl("TxtIGSTAmount"));
                        TextBox TxtTotalAmount = ((TextBox)row.FindControl("TxtTotalAmount"));

                        double v_TxtChargesAmount = Convert.ToDouble(TxtChargesAmount.Text.Trim());
                        double v_TxtCGSTAmount = Convert.ToDouble(TxtCGSTAmount.Text.Trim());
                        double v_TxtSGSTAmount = Convert.ToDouble(TxtSGSTAmount.Text.Trim());
                        double v_TxtIGSTAmount = Convert.ToDouble(TxtIGSTAmount.Text.Trim());
                        double v_TxtTotalAmount = Convert.ToDouble(TxtTotalAmount.Text.Trim());
                        ...
                        #region Calculation of Charges Amount

                        double decimalpoints1 = Math.Abs(v_TxtChargesAmount - Math.Floor(v_TxtChargesAmount));
                        if (decimalpoints1 >= 0.5)
                        {
                            double ro = 1 - decimalpoints1;

                            TxtROamt.Text = Math.Round(ro, 2).ToString();

                            TxtChargesAmount.Text = Convert.ToString(Convert.ToDouble(TxtChargesAmount.Text.Trim()) + ro);
                        }
                        else
                        {
                            double ro = (1 - decimalpoints1) - 1;

                            TxtROamt.Text = Math.Round(ro, 2).ToString();

                            TxtChargesAmount.Text = Convert.ToString(Math.Floor(v_TxtChargesAmount));
                        }

                        #endregion

                        #region Calculation Charges CGST Amount

                        double decimalpoints2 = Math.Abs(v_TxtCGSTAmount - Math.Floor(v_TxtCGSTAmount));
                        if (decimalpoints2 >= 0.5)
                        {
                            double ro = 1 - decimalpoints2;

                            TxtROamt.Text = Math.Round(ro, 2).ToString();

                            TxtCGSTAmount.Text = Convert.ToString(Convert.ToDouble(TxtCGSTAmount.Text.Trim()) + ro);
                        }
                        else
                        {
                            double ro = (1 - decimalpoints2) - 1;

                            TxtROamt.Text = Math.Round(ro, 2).ToString();

                            TxtCGSTAmount.Text = Convert.ToString(Math.Floor(v_TxtCGSTAmount));
                        }

                        #endregion


                        #region Calculation on Charges SGST Amount

                        double decimalpoints3 = Math.Abs(v_TxtSGSTAmount - Math.Floor(v_TxtSGSTAmount));
                        if (decimalpoints3 >= 0.5)
                        {
                            double ro = 1 - decimalpoints3;

                            TxtROamt.Text = Math.Round(ro, 2).ToString();

                            TxtSGSTAmount.Text = Convert.ToString(Convert.ToDouble(TxtSGSTAmount.Text.Trim()) + ro);
                        }
                        else
                        {
                            double ro = (1 - decimalpoints3) - 1;

                            TxtROamt.Text = Math.Round(ro, 2).ToString();

                            TxtSGSTAmount.Text = Convert.ToString(Math.Floor(v_TxtSGSTAmount));
                        }

                        #endregion


                        #region Calculation on Charges IGST Amount

                        double decimalpoints4 = Math.Abs(v_TxtIGSTAmount - Math.Floor(v_TxtIGSTAmount));
                        if (decimalpoints4 >= 0.5)
                        {
                            double ro = 1 - decimalpoints4;

                            TxtROamt.Text = Math.Round(ro, 2).ToString();

                            TxtIGSTAmount.Text = Convert.ToString(Convert.ToDouble(TxtIGSTAmount.Text.Trim()) + ro);
                        }
                        else
                        {
                            double ro = (1 - decimalpoints4) - 1;

                            TxtROamt.Text = Math.Round(ro, 2).ToString();

                            TxtIGSTAmount.Text = Convert.ToString(Math.Floor(v_TxtIGSTAmount));
                        }

                        #endregion


                        #region Calculation of Cahrges Total Amount

                        double decimalpoints5 = Math.Abs(v_TxtTotalAmount - Math.Floor(v_TxtTotalAmount));
                        if (decimalpoints5 >= 0.5)
                        {
                            double ro = 1 - decimalpoints5;

                            TxtROamt.Text = Math.Round(ro, 2).ToString();

                            TxtTotalAmount.Text = Convert.ToString(Convert.ToDouble(TxtTotalAmount.Text.Trim()) + ro);
                        }
                        else
                        {
                            double ro = (1 - decimalpoints5) - 1;

                            TxtROamt.Text = Math.Round(ro, 2).ToString();

                            TxtTotalAmount.Text = Convert.ToString(Math.Floor(v_TxtTotalAmount));
                        }
                ...
                {
                    #region Calculation of Chargres Decimal Amount

                    foreach (GridViewRow row in GvChagresTranDetails.Rows)
                    {
                        HiddenField HfChargesCode = ((HiddenField)row.FindControl("HfChargesCode"));
                        HiddenField HfGSTAmount = ((HiddenField)row.FindControl("HfGSTAmount"));
                        TextBox TxtChargesName = ((TextBox)row.FindControl("TxtChargesName"));
                        TextBox TxtQty = ((TextBox)row.FindControl("TxtQty"));
                        TextBox TxtRate = ((TextBox)row.FindControl("TxtRate"));
                        TextBox TxtChargesAmount = ((TextBox)row.FindControl("TxtChargesAmount"));
                        TextBox CGST_RATEString = ((TextBox)row.FindControl("TxtCGSTRate"));
                        TextBox SGST_RATEString = ((TextBox)row.FindControl("TxtSGSTRate"));
                        TextBox IGST_RATEString = ((TextBox)row.FindControl("TxtIGSTRate"));
                        TextBox TxtCGSTAmount = ((TextBox)row.FindControl("TxtCGSTAmount"));
                        TextBox TxtSGSTAmount = ((TextBox)row.FindControl("TxtSGSTAmount"));
                        TextBox TxtIGSTAmount = ((TextBox)row.FindControl("TxtIGSTAmount"));
                        TextBox TxtTotalAmount = ((TextBox)row.FindControl("TxtTotalAmount"));
                        ...
                        if (TxtQty.Text.Trim() != string.Empty && TxtRate.Text.Trim() != string.Empty)
                        {
                            TxtChargesAmount.Text = Convert.ToString(Convert.ToDouble(TxtQty.Text.Trim()) * Convert.ToDouble(TxtRate.Text.Trim()));

                            if ((HfTranType.Value == "S" && HfTrnType.Value == "P") || (HfTranType.Value == "S" && HfTrnType.Value == "T") || (HfTranType.Value == "S" && HfTrnType.Value == "R") || (HfTranType.Value == "S" && HfTrnType.Value == "C"))
                            {

                                if (DdlPartyType.SelectedValue.ToString() == "LOCAL")
                                {
                                    TxtCGSTAmount.Text = ((Convert.ToDouble(TxtChargesAmount.Text.Trim()) * Convert.ToDouble(CGST_RATEString.Text)) / 100).ToString();
                                    TxtSGSTAmount.Text = ((Convert.ToDouble(TxtChargesAmount.Text.Trim()) * Convert.ToDouble(SGST_RATEString.Text)) / 100).ToString();
                                    HfGSTAmount.Value = (Convert.ToDouble(TxtCGSTAmount.Text.Trim()) + Convert.ToDouble(TxtSGSTAmount.Text.Trim())).ToString();
                                    double d;
                                    d = ((Convert.ToDouble(TxtChargesAmount.Text.Trim())) + (Convert.ToDouble(TxtCGSTAmount.Text)) + (Convert.ToDouble(TxtSGSTAmount.Text)));
                                    TxtTotalAmount.Text = Convert.ToString(d);

                                }
                                else if (DdlPartyType.SelectedValue.ToString() == "CST")
                                {

                                    TxtIGSTAmount.Text = ((Convert.ToDouble(TxtChargesAmount.Text.Trim()) * Convert.ToDouble(IGST_RATEString.Text)) / 100).ToString();
                                    HfGSTAmount.Value = TxtIGSTAmount.Text;
                                    TxtTotalAmount.Text = ((Convert.ToDouble(TxtChargesAmount.Text.Trim())) + (Convert.ToDouble(TxtIGSTAmount.Text))).ToString();
        ...
        public void StockRecCalRoundFigure()
        {
            try
            {
                if (DdlFigureFlag.SelectedValue.ToString() == "R")
                {
                    foreach (GridViewRow row in GvStockRecDetails.Rows)
                    {
                        ...
                        HiddenField HfDisAmount = ((HiddenField)row.FindControl("HfDisAmount"));
                        HiddenField HfGrossAmount = ((HiddenField)row.FindControl("HfGrossAmount"));
                        ...
                        double v_HfAmount = Convert.ToDouble(HfAmount.Value.Trim());
                        double v_HfDisAmount = Convert.ToDouble(HfDisAmount.Value.Trim());
                        double v_HfGrossAmount = Convert.ToDouble(HfGrossAmount.Value.Trim());
                        ...
                        #region Calculation of Amount


                        double decimalpoints1 = Math.Abs(v_HfAmount - Math.Floor(v_HfAmount));
                        if (decimalpoints1 >= 0.5)
                        {
                            double ro = 1 - decimalpoints1;
                            ...
                            HfAmount.Value = Convert.ToString(Convert.ToDouble(HfAmount.Value.Trim()) + ro);
                        }
                        else
                        {
                            double ro = (1 - decimalpoints1) - 1;
                            ...
                            HfAmount.Value = Convert.ToString(Math.Floor(v_HfAmount));
                        }

                        #endregion

                        #region Calculation of Discount Amount

                        double decimalpoints = Math.Abs(v_HfDisAmount - Math.Floor(v_HfDisAmount));
                        if (decimalpoints >= 0.5)
                        {
                            double ro = 1 - decimalpoints;
                            ...
                            HfDisAmount.Value = Convert.ToString(Convert.ToDouble(HfDisAmount.Value.Trim()) + ro);
                        }
                        else
                        {
                            double ro = (1 - decimalpoints) - 1;
                            ...
                            HfDisAmount.Value = Convert.ToString(Math.Floor(v_HfDisAmount));
                        }

                        #endregion

                        #region Calculation of GrossAmount

                        double decimalpoints2 = Math.Abs(v_HfGrossAmount - Math.Floor(v_HfGrossAmount));
                        if (decimalpoints2 >= 0.5)
                        {
                            double ro = 1 - decimalpoints2;
                            ...
                            HfGrossAmount.Value = Convert.ToString(Convert.ToDouble(HfGrossAmount.Value.Trim()) + ro);
                        }
                        else
                        {
                            double ro = (1 - decimalpoints2) - 1;
                            ...
                            HfGrossAmount.Value = Convert.ToString(Math.Floor(v_HfGrossAmount));
                        }

                        #endregion

                        #region Calculation of CGST Amount

                        double decimalpoints3 = Math.Abs(v_TxtCGSTAmount - Math.Floor(v_TxtCGSTAmount));
                        if (decimalpoints3 >= 0.5)
                        {
                            double ro = 1 - decimalpoints3;
                        ...
                        #region Calculation of SGST Amount

                        double decimalpoints4 = Math.Abs(v_TxtSGSTAmount - Math.Floor(v_TxtSGSTAmount));
                        if (decimalpoints4 >= 0.5)
                        {
                            double ro = 1 - decimalpoints4;
                        ...
                        #region Calculation of IGST Amount

                        double decimalpoints5 = Math.Abs(v_TxtIGSTAmount - Math.Floor(v_TxtIGSTAmount));
                        if (decimalpoints5 >= 0.5)
                        {
                            double ro = 1 - decimalpoints5;
                        ...
                        #region Calculation of TotalAmount

                        double decimalpoints6 = Math.Abs(v_TxtTotalAmount - Math.Floor(v_TxtTotalAmount));
                        if (decimalpoints6 >= 0.5)
                        {
                            double ro = 1 - decimalpoints6;
                ...
                {
                    #region Calculation of Stock Decimal Amount 
                    ...
                    foreach (GridViewRow row in GvStockRecDetails.Rows)
                    {
                        ...
                        TextBox TxtProductCode = ((TextBox)row.FindControl("TxtProductCode"));
                        TextBox TxtProductName = ((TextBox)row.FindControl("TxtProductName"));
                        TextBox TxtRateString = ((TextBox)row.FindControl("TxtRate"));
                        TextBox TxtQuantityString = ((TextBox)row.FindControl("TxtQty"));
                        TextBox TxtDisRate = ((TextBox)row.FindControl("TxtDisRate"));

                        HiddenField HfAmountString = ((HiddenField)row.FindControl("HfAmount"));
                        HiddenField HfDisAmount = ((HiddenField)row.FindControl("HfDisAmount"));
                        HiddenField HfGrossAmount = ((HiddenField)row.FindControl("HfGrossAmount"));
                        HiddenField HfGSTAmount = ((HiddenField)row.FindControl("HfGSTAmount"));
                        ...
                        if (TxtDisRate.Text.Trim() != string.Empty && TxtQuantityString.Text != string.Empty && TxtRateString.Text != string.Empty)
                        {
                            //  HfAmountString.Value = Convert.ToString(Convert.ToDouble(TxtRateString.Text.Trim()) * Convert.ToDouble(TxtQuantityString.Text.Trim()));
                            ...
                            if ((HfTranType.Value == "S" && HfTrnType.Value == "P") || (HfTranType.Value == "S" && HfTrnType.Value == "T") || (HfTranType.Value == "S" && HfTrnType.Value == "R"))
                            {
                                ...
                                if (DdlPartyType.SelectedValue.ToString() == "LOCAL")
                                {
                                    TxtCGSTAmount.Text = (((disamt) * Convert.ToDouble(CGST_RATEString.Text)) / 100).ToString();
                                    TxtSGSTAmount.Text = (((disamt) * Convert.ToDouble(SGST_RATEString.Text)) / 100).ToString();
                                    HfGSTAmount.Value = (Convert.ToDouble(TxtCGSTAmount.Text.Trim()) + Convert.ToDouble(TxtSGSTAmount.Text.Trim())).ToString();
                                    double d;
                                    d = ((disamt) + (Convert.ToDouble(TxtCGSTAmount.Text)) + (Convert.ToDouble(TxtSGSTAmount.Text)));
                                    TxtTotalAmount.Text = Convert.ToString(d);
                                }
                                else if (DdlPartyType.SelectedValue.ToString() == "CST")
                                {
                                    TxtIGSTAmount.Text = (((disamt) * Convert.ToDouble(IGST_RATEString.Text)) / 100).ToString();
                                    HfGSTAmount.Value = TxtIGSTAmount.Text;
                                    TxtTotalAmount.Text = ((disamt) + Convert.ToDouble(TxtIGSTAmount.Text)).ToString();
                                }
                            }
                        }
