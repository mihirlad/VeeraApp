...
{
    public partial class ViewDeliveryChallanPrint : System.Web.UI.Page
    {
            ...
            try
            {
                if (Session["COMP_CODE"] != null &&
                    ...
                    Session["REPORT_TYPE"] != null)
                  {
                    ...
                    if(Session["TRAN_TYPE"].ToString()=="D" && Session["TRN_TYPE"].ToString() == "P" && Session["REPORT_TYPE"].ToString()== "DT_WS")
                    {
                        rprt.Load(Server.MapPath("~/ReportInventory/DeliveryChallanDateWisePurchaseReport.rpt"));
                    }
                    else if (Session["TRAN_TYPE"].ToString() == "D" && Session["TRN_TYPE"].ToString() == "S" && Session["REPORT_TYPE"].ToString() == "DT_WS")
                    {
                        rprt.Load(Server.MapPath("~/ReportInventory/DeliveryChallanDateWiseSalesReport.rpt"));
                    }

                    else if (Session["TRAN_TYPE"].ToString() == "D" && Session["TRN_TYPE"].ToString() == "P" && Session["REPORT_TYPE"].ToString() == "PT_WS")
                    {
                        rprt.Load(Server.MapPath("~/ReportInventory/DeliveryChallanPartyWisePurchaseReport.rpt"));
                    }

                    else if (Session["TRAN_TYPE"].ToString() == "D" && Session["TRN_TYPE"].ToString() == "S" && Session["REPORT_TYPE"].ToString() == "PT_WS")
                    {
                        rprt.Load(Server.MapPath("~/ReportInventory/DeliveryChallanPartyWiseSalesReport.rpt"));
                    }
                    ...
                    CryRptDecliveryChallan.Zoom(120);

                    CryRptDecliveryChallan.ReportSource = rprt;
