...
{
    public partial class ViewBranchTransactionPrintReport : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                    ...
                    Session["REPORT_TYPE"] != null)
                {
                    ...
                    {
                        rprt.Load(Server.MapPath("~/ReportInventory/BranchIssueRegister_DateWiseReport.rpt"));

                        Session["BRANCH_CODE_VALUE"].ToString();

                        ds = InventoryReport_Logiclayer.GetBRANCH_ISSUE_STK_IRMASFor_MainReport(Session["COMP_CODE"].ToString(), Session["BRANCH_CODE_VALUE"].ToString(), Convert.ToDateTime(Session["FROM_DATE"].ToString()), Convert.ToDateTime(Session["TO_DATE"].ToString()), Session["TRAN_TYPE"].ToString(), Session["CAT_CODE"] == null ? "0" : Session["CAT_CODE"].ToString(), Session["SCODE"] == null ? "0" : Session["SCODE"].ToString());
                    ...
                    {
                        rprt.Load(Server.MapPath("~/ReportInventory/BranchIssueRegisterDetails_DateWiseReport.rpt"));

                        Session["BRANCH_CODE_VALUE"].ToString();

                        ds = InventoryReport_Logiclayer.GetBRANCH_ISSUE_STK_IRMASFor_MainReport(Session["COMP_CODE"].ToString(), Session["BRANCH_CODE_VALUE"].ToString(), Convert.ToDateTime(Session["FROM_DATE"].ToString()), Convert.ToDateTime(Session["TO_DATE"].ToString()), Session["TRAN_TYPE"].ToString(), Session["CAT_CODE"] == null ? "0" : Session["CAT_CODE"].ToString(), Session["SCODE"] == null ? "0" : Session["SCODE"].ToString());

                        dsSub = InventoryReport_Logiclayer.GetBRANCH_ISSUE_STK_IRMASFor_SubReport(Session["CAT_CODE"] == null ? "0" : Session["CAT_CODE"].ToString(), Session["SCODE"] == null ? "0" : Session["SCODE"].ToString());
                    ...
                    {
                        rprt.Load(Server.MapPath("~/ReportInventory/BranchIssueRegister_BranchWiseReport.rpt"));
                    ...
                    {
                        rprt.Load(Server.MapPath("~/ReportInventory/BranchIssueRegisterDetails_BranchWiseReport.rpt"));
                    ...
                    CryRptBranchTranaction.Zoom(120);

                    CryRptBranchTranaction.ReportSource = rprt;
