...
{
    public partial class StockIssuetoBranchPrint : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["COMP_CODE"] != null &&
                 ...
                 rd.Load(Server.MapPath("~/reportCrystalrpts/StockIssuetoBranchRpt.rpt"));
               ...
               // SqlCommand cmd = new SqlCommand("select * from Viewstockissuetobranch where TRAN_NO= 3",con);
